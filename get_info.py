...
class GetInfo(object):
    ...
    def get_pinfo(self):
        ...
        res = requests.get(url, headers=self.headers, cookies=self.cookies,verify = False)
        jres = res.json()
        res_dict = {
            'name': jres['xm'],
            'studentId': jres['xh'],
    ...
    def get_grade(self, year, term):
        ...
        res = requests.post( url, headers=self.headers, data=data, cookies=self.cookies,verify = False)
        jres = res.json()
